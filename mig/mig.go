...
var mainTpl = template.Must(template.New("registered-mysqlDriver-struct-tpl").Parse(`package main

import ({{ range $name := .Names }}
    _ "./{{ $name }}"{{ end }}
    "github.com/rzajac/registered/cmd/registered/cmd"
)
